...
export function BuySellForm({ type, onClose }: BuySellFormProps) {
  ...
  const priceRangeOptions = type === "buy" 
    ? [
  ...
  const timelineOptions = type === "buy"
    ? [
        { value: "now", label: "NOW" },
  ...
  const handleSubmit = () => {
    ...
    toast({
      title: "Sucesso!",
      description: `Seu formulário de ${type === "buy" ? "compra" : "venda"} foi enviado com sucesso. Entraremos em contato em breve.`,
    })
    ...
    switch (currentStep) {
        ...
        return (
          <div className="space-y-8">
            <h2 className="text-3xl font-bold text-center text-white">
              {type === "buy" ? "What Are You Looking To Buy?" : "What Are You Looking To Sell?"}
            </h2>
      ...
      case 2:
        return (
          <div className="space-y-8">
            <h2 className="text-3xl font-bold text-center text-white">
              {type === "buy" ? "What's Your Price Range?" : "Expected Selling Price?"}
            </h2>
            <div className="grid gap-4">
      ...
      case 5:
        return (
          <div className="space-y-8">
            <h2 className="text-3xl font-bold text-center text-white">
              {type === "buy" ? "Timeline To Purchase" : "Timeline To Sell"}
            </h2>
            <div className="grid gap-4">
      ...
      case 6:
        return (
          <div className="space-y-8">
            <h2 className="text-3xl font-bold text-center text-white">
              {type === "buy" ? "Contact Information" : "Contact Info to Get a Free Evaluation"}
            </h2>
